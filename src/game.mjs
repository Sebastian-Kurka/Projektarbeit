document.addEventListener("DOMContentLoaded", function () {
    ...
    function checkWinner() {
        ...
        winPatterns.forEach(pattern => {
            ...
            const playerA = clickedCells.find(cell => cell.row === cellA.row && cell.col === cellA.col)?.player
            const playerB = clickedCells.find(cell => cell.row === cellB.row && cell.col === cellB.col)?.player
            const playerC = clickedCells.find(cell => cell.row === cellC.row && cell.col === cellC.col)?.player
    ...
    function checkDraw() {
        return clickedCells.length === 9 && !checkWinner() && clickedCells.every(cell => cell.player)
    }
